...
public class AlquilerViewController {
    ...
    public AlquilerViewController(AlquilerService alquilerService, ClienteService clienteService, VehiculoService vehiculoService, UsuarioService usuarioService) {
    ...
    @GetMapping("/admin/alquileres/nuevo")
    ...
    @PostMapping("/admin/alquileres/guardar")
